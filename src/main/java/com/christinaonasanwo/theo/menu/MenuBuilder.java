package com.christinaonasanwo.theo.menu;
...
public class MenuBuilder {
	...
	private void buildMenu()
	{
		...
		playHeading.add( new MenuItem( 
				...
				"com.christinaonasanwo.theo.playlist.PlaylistViewMenuItem"
				));
		...
		playHeading.add( new MenuItem( 
				...
				"com.christinaonasanwo.theo.music.MusicViewMenuItem"
				));
		...
		playHeading.add( new MenuItem( 
				...
				"com.christinaonasanwo.theo.user.UserViewMenuItem"
				));	
		...
		maintainHeading.add( new MenuItem( 
				...
				"Add User",
				"Add a user",
				"com.christinaonasanwo.theo.menu.UndefinedMenuItem"
				));		
